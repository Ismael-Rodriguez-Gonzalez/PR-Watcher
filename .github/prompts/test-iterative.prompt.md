...
- Al finalizar presenta de forma resumida las mejoras obtenidas respecto al test anterior y propón un nuevo caso de uso a testear, si lo hay.
...
- comprueba su funcionamiento con el siguiente comando, ejecutaló desde la raiz del proyecto: `npm -w @app/shellengine run test -- src/app/shell/shell.component.spec.ts --collectCoverageFrom src/app/shell/shell.component.ts`

1. Propón un caso de uso a testear
2. Espera confirmación
3. Crea **UNICAMENTE UN NUEVO TEST** en el archivo de testing <-- ESTO ES IMPORTANTE
